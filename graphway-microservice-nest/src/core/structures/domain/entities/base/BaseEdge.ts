import { EdgeId } from "../../valueObjects/EdgeId";
import { VertexId } from "../../valueObjects/VertexId";
...
export type BaseEdgeProperties = BaseEdgeEssentialProperties & Required<BaseEdgeOptionalProperties>
